  ...
  return (
    <header className={clsx('hero hero--primary', styles.heroBanner)}>
      <div className="container">
        ...
        <p>Avinadal is a content-creation community founded by Aries Villanite with the help of other creators of all kinds, from writers to artists to musicians. The primary goal of this organization is to create content based on the Universe of Avilium, but we also love gaming, watching anime, and doing all kinds of nerdy things as a group! If you’re looking for a new community, this may be a great place to join! To learn more about the community, please continue scrolling down to read about who we are and how you can join. If you want to read about Avilium, click the link above or in the navigation and let us know what you think!</p>
      </div>
    </header>
  );
}
    ...
    <Layout
      ...
      <main>
        <section className={styles.section}>
          <div className="container">
            <div className="row">
              <h2 className={styles.centeredHeading}>An adult community of kink-friendly content creators and their supporters using virtual personas.</h2>
